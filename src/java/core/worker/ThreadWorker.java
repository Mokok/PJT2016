...
public class ThreadWorker implements Runnable {
    ...
    private ThreadWorker(WorkerType type, Video task) {
	setVideoTask(task);
	setCmdType(type);
    }

    public static ThreadWorker getWorker(WorkerType type, Video task) {
	ThreadWorker result = new ThreadWorker(type, task);
